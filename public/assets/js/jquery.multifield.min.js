	...
	multiField.prototype = {
      ...
      if(this.config.locale !== 'default'){
		...
		cloneSection : function() {
            ...
            //let prItemQ = parseInt(this.getSectionsCount());
            let prItemQ = (Math.random() + 1).toString(36).substring(7);
            console.log(prItemQ);
			// Clone last section
			var newChild = $(this.config.section, this.$elem).last().clone().attr('style', '').attr('id', prItemQ).fadeIn('fast');
