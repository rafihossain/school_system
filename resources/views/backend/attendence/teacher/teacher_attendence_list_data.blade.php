                    ...
                    <td>
                        ...
                        <div class="d-flex">
                            <div class="form-check me-2">
                                <input type="radio" class="form-check-input" name="status_{{$teacher->id}}" value="present" 
                                @isset($teacher->teacher_single_attendence)
                                    {{$teacher->teacher_single_attendence->status == 'present' ? 'checked' : ''}}
                                @endisset> Present
                            </div>
                            <div class="form-check">
                                <input type="radio" class="form-check-input" name="status_{{$teacher->id}}" value="absent"
                                @isset($teacher->teacher_single_attendence)
